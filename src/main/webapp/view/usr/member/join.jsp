		...
		<form action="/usr/member/doJoin" method="post"
			...
			<div class="table-box">
				<table class="w-1/3">
					...
					<tr>
						<th>아이디</th>
						<td><input class="border w-full" name="loginId" type="text"
							onblur="loginIdDupChk(this);" />
							<div id="chkMsg" class="mt-2 text-sm h-5 text-left"></div></td>
					</tr>
					<tr>
						<th>비밀번호</th>
						<td><input class="border w-full" name="loginPw" type="password" /></td>
					</tr>
					<tr>
						<th>비밀번호 확인</th>
