...
<body>
	<div class="navbar bg-primary text-primary-content">
		<div class="navbar-start">
			...
			<div class="logo">
				<a href="/"><i class="fa-brands fa-gitlab"></i><div>Shieeet</div></a>
			</div>
		</div>
		<div class="navbar-center hidden lg:flex">
			<ul class="menu menu-horizontal px-1">
				<c:if test="${req.getLoginedMember().getId() != 0 }">
					<li><a href="/usr/article/write?boardId=2">Post</a></li>
				</c:if>
				<li>
					<details>
						<summary>List</summary>
						<ul class="summary p-2">
		...
		<div class="buttons navbar-end">
			<c:if test="${req.getLoginedMember().getId() == 0 }">
				<a href="/usr/member/join" class="btn">Join</a>
				<a href="/usr/member/login" class="btn">Login</a>
			</c:if>
			<c:if test="${req.getLoginedMember().getId() != 0 }">
				<a href="/usr/member/logout" class="btn">Logout</a>
			</c:if>
		</div>
	</div>
